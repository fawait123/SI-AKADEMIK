                ...
                <div class="auth-box h-full flex flex-col justify-center">
                    ...
                    <form class="space-y-4" action='{{route('login')}}' method="post">
                        ...
                        <div class="fromGroup">
                            ...
                            <div class="relative ">
                                <input type="text" name="username" class="form-control @error('username') is-invalid @enderror py-2" placeholder="Add placeholder" value="admin@admin.com">
                                @error('username')
                        ...
                        <div class="fromGroup       ">
                            ...
                            <div class="relative">
                                <input type="password" name="password" class="form-control @error('password') is-invalid @enderror py-2   " placeholder="Add placeholder" value="password">
                                @error('password')
                                <div class="invalid-feedback">{{$message}}</div>
                                @enderror
                            </div>
