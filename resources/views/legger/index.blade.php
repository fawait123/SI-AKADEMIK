            ...
            <div class="card-body px-6 pb-6">
                <div style="display: grid; grid-template-columns: auto auto">
                    <div>
                        ...
                        &nbsp;
                        <p>Download : <a href="{{ route('legger.download') }}" target="_blank"
                        ...
                        <table class="w-full">
                            ...
                            @foreach ($item->detail as $d)
                                <tr>
                                    ...
                                    <td class="border-[1.5px]">{{ $d->nilai->uh1 ?? 0 }}</td>
                                    <td class="border-[1.5px]">{{ $d->nilai->uh2 ?? 0 }}</td>
                                    <td class="border-[1.5px]">{{ $d->nilai->uh3 ?? 0 }}</td>
                                    <td class="border-[1.5px]">{{ $d->nilai->uts ?? 0 }}</td>
                                    <td class="border-[1.5px]">{{ $d->nilai->uas ?? 0 }}</td>
                                </tr>
                            @endforeach
                        </table>
                    @endforeach
