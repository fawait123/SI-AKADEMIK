                                    ...
                                    @foreach ($data as $item)
                                        @php
                                            ...
                                            if ($item->namespace == null) {
                                                $role = 'Admin';
                                            } elseif ($item->namespace == 'Kurikulum') {
                                                $role = 'Kurikulum';
                                            } else {
                                                $role = explode('\\', $item->namespace)[3];
                                            }
                                        @endphp
                                        <tr>
                                                ...
                                                <div class="flex space-x-3 rtl:space-x-reverse">
                                                    ...
                                                    @if ($item->namespace != null)
                                                        ...
                                                        <button class="action-btn" type="button" data-bs-toggle="modal"
                                                            data-bs-target="#small_modal{{ $loop->iteration }}">
                                                            <iconify-icon icon="heroicons:trash"></iconify-icon>
                                                        </button>
                                                    @else
                                                        <iconify-icon icon="material-symbols:disabled-by-default-sharp">
                                                        </iconify-icon>
                                                    @endif
                                                </div>
                                            </td>
