    ...
    <div class=" space-y-5">
        <div class="card">
            <header class=" card-header noborder">
                <a href="{{route('tahun-akademik.create')}}" class="btn btn-primary btn-sm">Tambah</a>
            </header>
...
{{--                                                    </button>--}}
                                                    <button class="action-btn" type="button" onclick="window.location.href='{{route('tahun-akademik.edit',$item->id_tahun)}}'">
                    ...
                    rounded-md outline-none text-current">
                                ...
                                dark:hover:bg-slate-600 dark:hover:text-white" data-bs-dismiss="modal">
                                        ...
                                        11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                                        ...
                                                        <!-- Modal footer -->
                                                        <form action="{{route('tahun-akademik.destroy',$item->id_tahun)}}" method="post">
                                                            @method('delete')
                                                            @csrf
