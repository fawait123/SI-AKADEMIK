                                ...
                                <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td class="table-td ">
                                                {{ $item->kelas->where('tahun.status', 'aktif')->first()->nama_kelas ?? 'belum disetting' }}
                                            </td>
                                            <td class="table-td ">{{ $item->deleted_at == null ? 'aktif' : 'tidak aktif' }}
                                            </td>
                                            <td class="table-td ">
                                                <div class="flex space-x-3 rtl:space-x-reverse">
                                                    ...
                                                    {{--                                                    </button> --}}
                                                    <button class="action-btn" type="button"
                                                        onclick="window.location.href='{{ route('siswa.edit', $item->id_siswa) }}'">
                                        ...
                                        <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
                                            id="small_modal{{ $loop->iteration }}" tabindex="-1"
                                            aria-labelledby="small_modal" aria-hidden="true">
                                        ...
                                        11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                                        ...
                                                        <form action="{{ route('siswa.destroy', $item->id_siswa) }}"
                                                            ...
                                                            <div
                                                                ...
                                                                <button
                                                                    class="btn inline-flex justify-center text-white bg-black-500">Hapus</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
