                ...
                <div class="card-body flex flex-col p-6">
                    <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-secondary-500">Default kehadiran yaitu <span class="font-bold">HADIR</span>, anda bisa mengubahnya dengan <span class="font-bold">IJIN</span> atau <span class="font-bold">ALPHA</span> sesuai dengan kehadiran siswa</p>
                        </div>
                    </header>
                    <div class="card-text h-full space-y-4">
                        @if(count($data)>0)
                                    ...
                                    <div class="flex items-center space-x-7 flex-wrap mb-3">
                                        ...
                                        <div class="basicRadio">
                                            <label class="flex items-center cursor-pointer">
                                                <input type="radio" class="hidden" name="kehadiran[{{$no}}]" required value="hadir" checked>
                                        ...
                                        <div class="basicRadio">
                                            <label class="flex items-center cursor-pointer">
                                                <input type="radio" class="hidden" name="kehadiran[{{$no}}]" required value="ijin">
                                                <span class="flex-none bg-white dark:bg-slate-500 rounded-full border inline-flex ltr:mr-2 rtl:ml-2 relative transition-all
                                        duration-150 h-[16px] w-[16px] border-slate-400 dark:border-slate-600 dark:ring-slate-700"></span>
                                        ...
                                        <div class="basicRadio">
                                            <label class="flex items-center cursor-pointer">
                                                <input type="radio" class="hidden" name="kehadiran[{{$no}}]" required value="alpha">
                                                <span class="flex-none bg-white dark:bg-slate-500 rounded-full border inline-flex ltr:mr-2 rtl:ml-2 relative transition-all
                                        duration-150 h-[16px] w-[16px] border-slate-400 dark:border-slate-600 dark:ring-slate-700"></span>
