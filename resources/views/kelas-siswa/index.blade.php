    ...
    <div class=" space-y-5">
        <div class="card">
            <header class=" card-header noborder">
                <a href="{{route('kelas-siswa.create')}}" class="btn btn-primary btn-sm">Tambah</a>
            </header>
...
{{--                                                    </button>--}}
                                                    <button class="action-btn" type="button" onclick="window.location.href='{{route('kelas-siswa.edit',$item->id_kelas)}}'">
                    ...
                    rounded-md outline-none text-current">
                                ...
                                dark:hover:bg-slate-600 dark:hover:text-white" data-bs-dismiss="modal">
                                        ...
                                        11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                                        ...
                                                        <!-- Modal footer -->
                                                        <form action="{{route('kelas-siswa.destroy',$item->id_kelas)}}" method="post">
                                                            @method('delete')
                                                            @csrf
