                                ...
                                <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                    @foreach($data as $item)
                                        <tr>
                                            ...
                                            <td class="table-td ">
                                                <span class="badge bg-info-800 text-white">{{$item->namespace == null ? 'Admin' : explode('\\',$item->namespace)[3]}}</span>
                                            </td>
                                            <td class="table-td ">
...
{{--                                                    </button>--}}
                                                    @if($item->namespace != null)
                                                        <button class="action-btn" type="button" onclick="window.location.href='{{route('user.edit',$item->id)}}'">
                                                    ...
                                                    @else
                                                        <iconify-icon icon="material-symbols:disabled-by-default-sharp"></iconify-icon>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
